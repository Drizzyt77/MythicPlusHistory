...
Automatically detects when a Mythic+ key starts and records the result when it ends. Every run is saved with dungeon, key level, completion time, and outcome — timed, depleted, abandoned, or reset.

### Group History

Each run captures the full group composition: player name, realm, class, spec, role, and Mythic+ score. Click any run in the list to see a full breakdown of who you ran with.
...
Quick access from a draggable minimap icon. Position is saved between sessions.
